...
/// 七牛云连麦推流预览窗口
class QiniucloudConnectPushView extends StatefulWidget {
  /// 系统参数
  ...
  /// 创建事件
  final ValueChanged<QiniucloudConnectedPushViewController> onViewCreated;

  const QiniucloudConnectPushView({
    Key key,
    this.onViewCreated,
  ...
  @override
  State<StatefulWidget> createState() => QiniucloudConnectPushViewState();
}

class QiniucloudConnectPushViewState extends State<QiniucloudConnectPushView> {
  /// 唯一标识符，需要与PlatformView标识对应
  static const String type = "plugins.huic.top/QiniucloudConnectedPush";
  ...
  void _onPlatformViewCreated(int id) {
    if (widget.onViewCreated != null) {
      widget.onViewCreated(QiniucloudConnectedPushViewController(id));
    }
  }
}
